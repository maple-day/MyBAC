		...
		<table class="easyui-datagrid" fit="true" nowrap="false">
			<thead>
				<tr>
					...
					<th data-options="field:'pick',width:180">办理任务</th>
				</tr>
			</thead>
			<script type="text/javascript">
			...
			<tbody>
				<s:iterator value="list" var="task">
					<tr>
						...
						<td>
							<s:a action="taskAction_%{taskDefinitionKey}" namespace="/" cssClass="easyui-linkbutton">通过
								<s:param name="taskId" value="id"></s:param>
								<s:param name="check" value="1"></s:param>
							</s:a>
							<s:a action="taskAction_%{taskDefinitionKey}" namespace="/" cssClass="easyui-linkbutton">不通过
								<s:param name="taskId" value="id"></s:param>
								<s:param name="check" value="0"></s:param>
							</s:a>
						</td>
					</tr>
				</s:iterator>
